const { proto, DEFAULT_CONNECTION_CONFIG, toNumber, updateMessageWithReceipt, jidNormalizedUser } = require('@whiskeysockets/baileys')
const make_ordered_dictionary_1 = require("@whiskeysockets/baileys/lib/Store/make-ordered-dictionary")
const waChatKey = (pin) => ({
